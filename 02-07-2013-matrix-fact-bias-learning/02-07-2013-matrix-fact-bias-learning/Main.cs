...
namespace matrixfactbiaslearning
{
	class MainClass
	{
		...
		{	
			...
			System.IO.File.WriteAllLines("/home/whitepearl/upb/Program/02-07-2013-matrix-fact-bias-learning/error.txt", line);						
		}
		...
		{	
			...
			readTrainSet("/home/whitepearl/upb/Program/02-07-2013-matrix-fact-bias-learning/dataset_train.txt", 
			             ref userIdMapping, 
			             ref movieIdMapping, 
			             ref userIdList, 
			             ref movieIdList, 
			...
			Process.Start("/home/whitepearl/upb/Program/02-07-2013-matrix-fact-bias-learning/plot.sh");
		}		
	}
}