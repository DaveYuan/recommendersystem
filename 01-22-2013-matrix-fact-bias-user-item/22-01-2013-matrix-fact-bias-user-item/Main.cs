...
namespace matrixfactbiasuseritem
{
	class MainClass
	{
		...
		{	
			...
			for (int j = 0; j < numFeatures; ++j) {	
				...
				for (itr = 0; itr < epochs; ++itr) {
					...
					for (int q = 0; q < numEntries; ++q) {						
						...
						userBiasHash[userIdList[q]] += lrate * (err - Kbias * userBiasHash[userIdList[q]]);
						movieBiasHash[movieIdList[q]] += lrate * (err - Kbias * movieBiasHash[movieIdList[q]]);
			...
			System.IO.File.WriteAllLines("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-bias-user-item/error.txt", line);						
		}
		...
		{	
			...
			readTrainSet("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-bias-user-item/dataset_train.txt", 
			             ref userIdMapping, 
			             ref movieIdMapping, 
			             ref userIdList, 
			             ref movieIdList, 
			...
			Process.Start("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-bias-user-item/plot.sh");
		}		
	}
}