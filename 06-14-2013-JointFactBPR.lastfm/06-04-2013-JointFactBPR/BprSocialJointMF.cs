...
//			userBias[userIdPostv] += (double) (lrate * regSocial * (oneByOnePlusExpX - regPostv * regUser * userBias[userIdPostv]));
//			userBias[userIdNegtv] += (double) (lrate * regSocial * (-oneByOnePlusExpX - regNegtv * regUser * userBias[userIdNegtv]));
