...
namespace matrixfactuseritem
{
	class MainClass
	{
		...
		{	
			...
			System.IO.File.WriteAllLines("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-user-item/error.txt", line);						
		}
		...
		{	
			...
			readTrainSet("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-user-item/dataset_train.txt", 
			             ref userIdMapping, 
			             ref movieIdMapping, 
			             ref userIdList, 
			             ref movieIdList, 
			...
			Process.Start("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-user-item/plot.sh");
		}		
	}
}