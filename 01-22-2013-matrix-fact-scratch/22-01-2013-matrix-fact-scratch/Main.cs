...
namespace matrixfactscratch
{
	class MainClass
	{
		...
		{	
			...
			System.IO.File.WriteAllLines("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-scratch/error.txt", line);						
		}
		...
		{	
			...
			readTrainSet("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-scratch/dataset_train.txt", 
			             ref userIdMapping, 
			             ref movieIdMapping, 
			             ref userIdList, 
			             ref movieIdList, 
			...
			Process.Start("/home/whitepearl/upb/Program/01-22-2013-matrix-fact-scratch/plot.sh");
		}		
	}	
}
